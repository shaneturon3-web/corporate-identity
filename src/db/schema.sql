-- ProSpine / CoreSpine D1 schema reference (apply via db/migrations/*.sql)
-- Professional wrapper tables (Order 005) — isolated from healthcare_* tables

-- TaxFilingStatus: Discovery | Documents_Pending | Review | Filed | Completed
